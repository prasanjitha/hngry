...
import 'package:hngry/screens/skip_screen_three.dart';

import 'skip_screen_four.dart';

class NavigationScreenTwo extends StatelessWidget {
  const NavigationScreenTwo({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset('assets/splash/Image02.png',width: 270,height: 234.58,),
            SizedBox(height:40),
            ...
            Image.asset('assets/splash/SliderdotsMiddle.png'),
            SizedBox(height:20),

              InkWell(
      onTap: () {
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => NavigationScreenThree()));
